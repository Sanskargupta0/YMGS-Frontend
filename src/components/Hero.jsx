      ...
      <section className="pt-24 pb-12 container">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 animate-fade-up">
            <span className="bg-secondary dark:bg-gray-700 text-primary dark:text-yellow-400 px-4 py-1 rounded-full text-sm font-medium">
              24/7 Healthcare Support
            </span>
            <h1 className="mt-6 font-display text-4xl md:text-6xl font-semibold text-primary dark:text-yellow-400 leading-tight">
